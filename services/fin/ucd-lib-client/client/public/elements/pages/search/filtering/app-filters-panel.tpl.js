...
export default function render() { 
  ...
  <!-- <div class="outer-drawer-toggle" ?spacer="${!this.collectionMode}" on-click="_fireToggleDrawer">
  ...
  <div class="thumbnail-root"  ?hidden="${!this.collectionMode}">
    <div class="thumbnail" style="background-image: url('${this.selectedCollection.thumbnailUrl}')"></div>
    <!-- <div class="thumbnail" style="background-image: url('${this.selectedCollection.thumbnail}')"></div>  -->
  </div>
  ...
  <iron-pages 
    ...
    <div id="filters">
      ...
      <!-- <div ?hidden="${!this.collectionMode}" class="label">Collection</div>
      ...
      ${this.facetFilters.map((item, index) => html`
